...
function AboutPage(){
    ...
    return (
        <div className="bg-gray-100 py-10 px-10 flex flex-col gap-10">
            ...
            <div className="container space-y-5">
                ...
                {techStack.map((tech) => (
                    <div key={tech.name} className="flex p-4 bg-gray-50 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300 min-w-3xs max-w-3xs">
